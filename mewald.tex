...
\cventry{2024--tdy}{Ecosystem Solutions Architect}{GitLab}{Munich}{}{
  Act as a trusted technical advisor for strategic partners in the DACH region,
  helping them build successful DevSecOps practices with GitLab. Leverage deep expertise
  in CI/CD, security, and infrastructure automation to enable partners in driving
  customer success beyond installation and migration. Deliver technical enablement,
  conduct workshops, and provide architectural guidance to ensure partners can
  independently position and implement GitLab solutions. Collaborate cross-functionally
  with sales, product, and alliances teams to align partner strategies with business goals.
  Advocate for partner needs within GitLab, helping shape product and go-to-market
  strategies. \newline{}
}

\cventry{2020--2024}{Solutions Engineer}{VMware}{Vienna}{}{
